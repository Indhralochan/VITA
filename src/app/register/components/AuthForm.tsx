...
import { getAuth, setPersistence, createUserWithEmailAndPassword, browserSessionPersistence, signInWithPopup, GithubAuthProvider} from "firebase/auth";
                ...
                <div className={cn("grid gap-6", className)} {...props}>
                    ...
                    <form onSubmit={onSubmit}>
                        <div className="grid gap-2">
                            ...
                            <Button disabled={isLoading} onClick={()=>{handleSignIn(email,password)}}> 
                                {isLoading && (
